...
COURSE_OBLIGATORY_FIELDS_STAFF = [
    'prequesites_gr',
    'prequesites_en',
    'url',
    'language_gr',
...
class CourseForm(ModelForm):
    ...
    def clean(self):
        ...
        if ects_hours != total_hours:
            msg = 'Έχετε συμπληρώσει %6.2f ώρες φόρτου στις δραστηριότητες ενώ ο φόρτος που προκύπτει από τα ECTS είναι %6.2f ώρες. Παρακαλούμε διορθώστε τον επιμερισμό του φόρτου' % (
                total_hours, ects_hours)
