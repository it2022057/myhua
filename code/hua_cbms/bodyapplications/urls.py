...
urlpatterns = [
    # Secretary URLs for reading, updating and deleting applications
    ...
    # Secure URL for viewing an application through a signed email + application_pk token
    ...
    # URLs for Applicants for creating, updating and reading applications
