...
urlpatterns = [
    ...
    # User signup and registration URLs
    ...
    # Dashboard and password management URLs
    ...
    # URLs for Secretary CRUD for staff members
    ...
    # URLs for Secretary reading, updating and deleting a user's personal information
    ...
    path('sec/staff/<int:pk>/personal-info/<int:pi_pk>/delete', views.SecDeletePersonalInfo.as_view(), name='sec_delete_personal_info'),
